...
![图 17-1 三个标准描述符](../assets/diagrams/streams.svg)
...
![图 17-3 重定向顺序改变目标](../assets/diagrams/redirection-order.svg)

> 先预测｜把同一条命令的两个重定向交换位置，先画出 1 和 2 的去向，再运行对比。描述符复制发生在那一刻，后面再改 1 不会让 2 自动跟随。
...
![图 17-2 排序与统计的管道](../assets/diagrams/pipeline.svg)
