...
def main():
    ...
    opf=f'''<?xml version="1.0" encoding="utf-8"?><package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="bookid" xml:lang="zh-CN"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:identifier id="bookid">{uid}</dc:identifier><dc:title>Hola Euler · openEuler Linux 从命令行到服务器实战</dc:title><dc:creator>Alex</dc:creator><dc:language>zh-CN</dc:language><dc:description>{version}，内部审阅版；技术验证范围见书内说明。</dc:description><meta property="dcterms:modified">2026-09-23T00:00:00Z</meta><meta name="cover" content="cover-image"/></metadata><manifest>{''.join(manifest)}</manifest><spine toc="ncx">{''.join(spine)}</spine></package>'''
